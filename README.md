...
4. Crear una nueva publicacion desde el formulario.
5. Explicar que se guarda en `localStorage`.
6. Mostrar la seccion "Registro principal" y justificar `idPublicacion` como clave principal.
>>>>>>> bf24cbe (Primer commit)
