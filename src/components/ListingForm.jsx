    ...
    <section className="form-panel" aria-labelledby="form-title">
      <div className="section-heading compact">
        <div>
          ...
          <h2 id="form-title">Cargar publicacion</h2>
        </div>
        <span className="next-id">Proximo ID de publicacion: {siguienteId}</span>
      </div>
